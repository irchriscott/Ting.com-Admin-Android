...
class AddPromotionDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        view.dialog_title.text = "Add Promotion"
        ...
        view.action_insert_link.setOnClickListener(View.OnClickListener {
            ...
            linkEditorDialog.setOnLinkSet(object : EditorLinkListener {
                override fun onLinkSet(link: String, title: String) {
                    ...
                    } else { TingToast(context!!, "Please, Insert Link URL", TingToastType.ERROR).showToast(
                        Toast.LENGTH_LONG) }
                }
            })
        ...
        view.promotion_on_select.setOnClickListener {
            ...
            val bundle = Bundle()
            bundle.putString(Constants.CONFIRM_TITLE_KEY, "Select Promotion Menu")
            selectDialog.arguments = bundle
            selectDialog.setItems(Constants.PROMOTION_MENU.toSortedMap().map { it.value }, object :
                SelectItemListener {
                override fun onSelectItem(position: Int) {
                    selectedPromotionOn = "0$position"
                    ...
                    when (position) {
                        4 -> {
                            view.promotion_specific_menu_label.setTextColor(resources.getColor(R.color.colorGray))
                            view.promotion_specific_category_label.setTextColor(resources.getColor(R.color.colorLightGray))
                            view.selected_promotion_specific_category.setTextColor(resources.getColor(
                                R.color.colorLightGray))
                            if(selectedSpecificMenu != null) {
                                view.selected_promotion_specific_menu.setTextColor(resources.getColor(
                                    R.color.colorGray))
                            }
                        }
                        5 -> {
                            view.promotion_specific_menu_label.setTextColor(resources.getColor(R.color.colorLightGray))
                            view.promotion_specific_category_label.setTextColor(resources.getColor(R.color.colorGray))
                            view.selected_promotion_specific_menu.setTextColor(resources.getColor(R.color.colorLightGray))
                            if(selectedSpecificCategory != null) {
                                view.selected_promotion_specific_category.setTextColor(resources.getColor(
                                    R.color.colorGray))
                            }
                        }
        ...
        view.promotion_specific_menu_select.setOnClickListener {
                    ...
                    activity?.runOnUiThread {
                        if (isSuccess) {
                            try {
                                ...
                                selectBundle.putString(Constants.CONFIRM_TITLE_KEY, "Select Promotion Menu")
                                selectDialog.arguments = selectBundle
                                selectDialog.setMenus(menus, object :
                                    SelectItemListener {
                                    override fun onSelectItem(position: Int) {
                                        val menu = menus[position]
                                        selectedSpecificMenu = menu.id
                                        view.selected_promotion_specific_menu.text = menu.menu.name
                                        view.selected_promotion_specific_menu.setTextColor(resources.getColor(
                                            R.color.colorGray))
                                        selectDialog.dismiss()
                                    }
            ...
            } else { TingToast(context!!, "Promotion On should be Specific Menu", TingToastType.DEFAULT).showToast(
                Toast.LENGTH_LONG) }
        }

        view.promotion_specific_category_select.setOnClickListener {
            if(selectedPromotionOn  == "05") {
                    ...
                    activity?.runOnUiThread {
                        if (isSuccess) {
                            try {
                                ...
                                val selectDialog = SelectDialog()
                                val selectBundle = Bundle()
                                selectBundle.putString(Constants.CONFIRM_TITLE_KEY, "Select Promotion Category")
                                selectDialog.arguments = selectBundle
                                selectDialog.setItems(categories.map { it.name }, object :
                                    SelectItemListener {
                                    override fun onSelectItem(position: Int) {
                                        val category = categories[position]
                                        selectedSpecificCategory = category.id
                                        view.selected_promotion_specific_category.text = category.name
                                        view.selected_promotion_specific_category.setTextColor(resources.getColor(
                                            R.color.colorGray))
                                        selectDialog.dismiss()
                                    }
            ...
            } else { TingToast(context!!, "Promotion On should be Specific Category", TingToastType.DEFAULT).showToast(
                Toast.LENGTH_LONG) }
        }
        ...
        view.promotion_start_date.setOnClickListener {
            if(view.is_promotion_special.isChecked) {
                DatePickerDialog(activity!!,
                    R.style.DatePickerAppTheme, startDate, calendar.get(Calendar.YEAR), calendar.get(
        ...
        view.promotion_end_date.setOnClickListener {
            if(view.is_promotion_special.isChecked) {
                DatePickerDialog(activity!!,
                    R.style.DatePickerAppTheme, endDate, calendar.get(Calendar.YEAR), calendar.get(
                        Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show()
            } else { TingToast(context!!, "Check Is Promotion Special", TingToastType.DEFAULT).showToast(
                Toast.LENGTH_LONG) }
        }
        ...
        view.promotion_has_supplement.setOnCheckedChangeListener { _, isChecked ->
            view.promotion_minimum_quantity_supplement_label.setTextColor(resources.getColor(
                Constants.SELECT_COLORS[isChecked]!!))
                            ...
                            try {
                                ...
                                selectDialog.setMenus(menus, object :
                                    ...
                                    override fun onSelectItem(position: Int) {
                                        ...
                                        view.selected_promotion_supplement_menu.setTextColor(resources.getColor(
                                            R.color.colorGray))
                                        selectDialog.dismiss()
                                    }
                                })
        ...
        view.dialog_button_save.setOnClickListener {
            ...
            val requestBodyBuilder = MultipartBody.Builder().setType(MultipartBody.FORM)
                ...
                .addFormDataPart("promotion_menu_type", selectedPromotionOn?:"00")
                .addFormDataPart("menu", selectedSpecificMenu.toString())
                .addFormDataPart("category", selectedSpecificCategory.toString())
