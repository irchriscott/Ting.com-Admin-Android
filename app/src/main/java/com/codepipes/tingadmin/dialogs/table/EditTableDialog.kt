...
class EditTableDialog : DialogFragment() {

    private var selectedTableLocation: Int = 1
    private var selectedChairType: Int = 1
    ...
    override fun onCreateView(
        ...
        selectedTableLocation = table.location
        selectedChairType = table.chairType

        view.table_number.setText(table.number.toString())
        view.table_max_people.setText(table.maxPeople.toString())
        view.selected_table_location.text = Constants.TABLE_LOCATION[table.location]
        view.selected_table_location.setTextColor(context?.resources?.getColor(R.color.colorGray)!!)
        view.selected_table_chair_type.text = Constants.CHAIR_TYPE[table.chairType]
        view.selected_table_chair_type.setTextColor(context?.resources?.getColor(R.color.colorGray)!!)
        view.table_description.setText(table.description)
        ...
        view.table_location_select.setOnClickListener {
            ...
            selectDialog.setItems(Constants.TABLE_LOCATION.toSortedMap().map { it.value }, object :
                ...
                override fun onSelectItem(position: Int) {
                    ...
                    view.selected_table_location.text = Constants.TABLE_LOCATION[selectedTableLocation]
                    view.selected_table_location.setTextColor(context?.resources?.getColor(R.color.colorGray)!!)
        ...
        view.table_chair_type_select.setOnClickListener {
            ...
            selectDialog.setItems(Constants.CHAIR_TYPE.toSortedMap().map { it.value }, object :
                ...
                override fun onSelectItem(position: Int) {
                    ...
                    view.selected_table_chair_type.text = Constants.CHAIR_TYPE[selectedChairType]
                    view.selected_table_chair_type.setTextColor(context?.resources?.getColor(R.color.colorGray)!!)
                    selectDialog.dismiss()
                }
            })
        ...
        view.dialog_button_save.setOnClickListener {
            ...
            TingClient.postRequest("${Routes.updateTable}${table.id}/", data, null, session.token) { _, isSuccess, result ->
