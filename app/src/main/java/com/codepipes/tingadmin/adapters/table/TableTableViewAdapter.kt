...
class TableTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val tableTableViewModel: TableTableViewModel = TableTableViewModel()
    ...
    override fun getCellItemViewType(position: Int): Int =
        TableTableViewModel.getCellItemViewType(position)
    ...
    fun setTablesList(tables: List<RestaurantTable>) {
        tableTableViewModel.generateListForTableView(tables)
        setAllItems(
