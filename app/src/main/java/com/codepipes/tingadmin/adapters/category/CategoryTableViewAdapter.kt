...
import com.codepipes.tingadmin.adapters.admin.AdministratorTableViewModel
...
class CategoryTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val categoryTableViewModel: CategoryTableViewModel = CategoryTableViewModel()
    ...
    override fun getCellItemViewType(position: Int): Int =
        CategoryTableViewModel.getCellItemViewType(position)
    ...
    fun setCategoriesList(categories: List<FoodCategory>) {
        categoryTableViewModel.generateListForTableView(categories)
        setAllItems(
            categoryTableViewModel.columnHeaderModeList, categoryTableViewModel
                .rowHeaderModelList, categoryTableViewModel.cellModelList
        )
    }
}
