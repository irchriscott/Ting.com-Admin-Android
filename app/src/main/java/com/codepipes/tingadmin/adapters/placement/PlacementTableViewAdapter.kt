...
class PlacementTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val placementTableViewModel: PlacementTableViewModel = PlacementTableViewModel()
    ...
    override fun onCreateCellViewHolder(parent: ViewGroup, viewType: Int): AbstractViewHolder {
        return when (viewType) {
            ...
            Constants.WAITER_TABLE_VIEW_CELL -> {
                val layout = LayoutInflater.from(context)
                    .inflate(R.layout.tableview_cell_table_waiter_view, parent, false)
    ...
    override fun onBindCellViewHolder(
        ...
        when (holder) {
            ...
            is TableWaiterCellViewHolder -> {
                (holder as TableWaiterCellViewHolder).setCellModel(cell!!, columnPosition)
            }
    ...
    override fun getCellItemViewType(position: Int): Int =
        PlacementTableViewModel.getCellItemViewType(position)
    ...
    fun setPlacementsList(placements: List<Placement>) {
        placementTableViewModel.generateListForTableView(placements)
        setAllItems(
            placementTableViewModel.columnHeaderModeList, placementTableViewModel
                .rowHeaderModelList, placementTableViewModel.cellModelList
        )
    }
}