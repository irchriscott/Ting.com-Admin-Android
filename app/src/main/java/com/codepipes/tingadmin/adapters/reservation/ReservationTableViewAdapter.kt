...
class ReservationTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val reservationTableViewModel: ReservationTableViewModel = ReservationTableViewModel()
    ...
    override fun getCellItemViewType(position: Int): Int =
        ReservationTableViewModel.getCellItemViewType(position)
    ...
    fun setReservationsList(bookings: List<Booking>) {
        reservationTableViewModel.generateListForTableView(bookings)
        setAllItems(
            reservationTableViewModel.columnHeaderModeList, reservationTableViewModel
                .rowHeaderModelList, reservationTableViewModel.cellModelList
        )
    }
}
