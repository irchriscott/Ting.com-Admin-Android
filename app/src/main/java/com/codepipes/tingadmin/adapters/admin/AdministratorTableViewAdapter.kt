...
class AdministratorTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val administratorTableViewModel: AdministratorTableViewModel = AdministratorTableViewModel()
    ...
    override fun getCellItemViewType(position: Int): Int = AdministratorTableViewModel.getCellItemViewType(position)
    ...
    fun setAdminsList(admins: List<Administrator>) {
        administratorTableViewModel.generateListForTableView(admins)
        setAllItems(
            administratorTableViewModel.columnHeaderModeList, administratorTableViewModel
                .rowHeaderModelList, administratorTableViewModel.cellModelList
        )
    }
}