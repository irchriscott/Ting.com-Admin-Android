...
class MenuDrinkTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val menuDrinkTableViewModel: MenuDrinkTableViewModel = MenuDrinkTableViewModel()
    ...
    override fun getCellItemViewType(position: Int): Int = MenuDrinkTableViewModel.getCellItemViewType(position)
    ...
    fun setMenuDrinkList(menus: List<Menu>) {
        menuDrinkTableViewModel.generateListForTableView(menus)
        setAllItems(
            menuDrinkTableViewModel.columnHeaderModeList, menuDrinkTableViewModel
                .rowHeaderModelList, menuDrinkTableViewModel.cellModelList
        )
    }
}