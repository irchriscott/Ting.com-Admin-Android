package com.codepipes.tingadmin.adapters.menu.food
...
class MenuFoodTableViewAdapter (val context: Context) : AbstractTableAdapter<ColumnHeaderModel?, RowHeaderModel?, CellModel?>() {

    private val menuFoodTableViewModel: MenuFoodTableViewModel = MenuFoodTableViewModel()
    ...
    override fun getCellItemViewType(position: Int): Int = MenuFoodTableViewModel.getCellItemViewType(position)
    ...
    fun setMenuFoodList(menus: List<Menu>) {
        menuFoodTableViewModel.generateListForTableView(menus)
        setAllItems(
            menuFoodTableViewModel.columnHeaderModeList, menuFoodTableViewModel
                .rowHeaderModelList, menuFoodTableViewModel.cellModelList
        )
    }
}